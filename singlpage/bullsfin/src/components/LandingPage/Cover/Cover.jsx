        ...
        <Grid container>
            ...
            <Grid item xs={10} sx={{padding:10}}>
                <Grid container justifyContent="center">
                    ...
                    Get 
                    <span style={{color:"black",marginLeft:10}}>Cashback</span> For EveryTrade You Make!
                    </Typography >
                    </Grid>
                    <Grid item xs={2}></Grid>
                    <Grid item xs={8}>
                    <Typography variant="h5" align="center"  sx={{color:'black'}}>
                        Open your trading account via Bullsfin and
                        benefit from cashback and other benefits immediately.
                    </Typography >
                    </Grid>
                    <Grid item xs={2}></Grid>
                    <Grid item xs={4}></Grid>
